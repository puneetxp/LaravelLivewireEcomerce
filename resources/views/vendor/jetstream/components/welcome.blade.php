...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        ...
        <div  x-data='{
              add:false,
              addresses : {{ Auth::user()->addresslimits }}}' class="ml-12">
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        ...
        <div  x-data='{
              add:false,
              orders : {{ Auth::user()->orderlimits }}}' class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        ...
        <div  x-data='{
              favorites : {{Auth::user()->fav}}}' x-init="console.log(favorites.length)" class="ml-12">
            <div class="mt-2 text-sm text-gray-500">
