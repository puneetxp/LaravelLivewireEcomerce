    ...
    <table border="1">
      ...
      <form>
        <tr id="<?php echo e($user->id); ?>}">
          ...
          <td>
            <button class=" <?php if($user->satus==0): ?> bg-blue-500 <?php endif; ?> " wire:click="satus(<?php echo e($user->id); ?>, 0)"> Active</button>
            <button class=" <?php if($user->satus==1): ?> bg-blue-500 <?php endif; ?> " wire:click="satus(<?php echo e($user->id); ?>, 1)"> Block</button>
          </td>
        </tr>
      </form>
...
</div><?php /**PATH /var/www/ecomerce-kunal/resources/views/livewire/admin/useradmin.blade.php ENDPATH**/ ?>