<div class=" w-full h-96 flex items-center justify-items-start">
  <div class=" p-2 w-full mt-8 sm:p-2 md:p-2 lg:p-2  ">
    <form action="<?php echo e(route('public.search')); ?>">
...
</div><?php /**PATH /home/puneetxp/Downloads/Telegram Desktop/SupremePure/resources/views/components/home/search.blade.php ENDPATH**/ ?>