...
<div class="bg-indigo-900 p-2 text-white sm:p-4">
    <div class="mx-auto grid gap-2 max-w-7xl sm:gap-3 lg:gap-6 sm:grid-cols-2">
        ...
        <div class="m-auto sm:m-0 text-center">
            ...
            <a href="<?php echo e(route('pageview', $page->slug)); ?>">
...
<?php /**PATH /home/puneetxp/Downloads/Telegram Desktop/SupremePure/resources/views/components/nav/footer.blade.php ENDPATH**/ ?>